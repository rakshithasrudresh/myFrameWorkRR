...
public class BySelectingAllTheChekboxsAndChangeTheOportunityName_TC_29Test {
	 @Test
		public void checkboxsandfillMandatoryFeildsChangeopurnameTC_29Test() throws Throwable
		{
			...
			// String closedate = ce2.toString();
			//double closedate = ce2.getNumericCellValue();
			//Date closedate = ce2.getDateCellValue();
			
			Cell ce3 = ro.getCell(3);
			String newlastname = ce3.getStringCellValue();
			String newlastnameran=newlastname+" "+random;
			...
			driver.findElement(By.id("jscal_field_closedate")).sendKeys("2022-2-25");
			
			
			driver.findElement(By.name("lastname")).clear();
			driver.findElement(By.name("lastname")).sendKeys(newlastnameran);
