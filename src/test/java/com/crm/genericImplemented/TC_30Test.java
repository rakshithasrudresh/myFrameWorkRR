...
public class TC_30Test {
	 @Test
		public void SelectingAllTheChekboxsAndGiveValidDataToExpectedCloseDateTC_30Test() throws Throwable
		{
		 ...
		 /*read data*/
			...
			String closedate=eLib.readDataFromExcel("leads", 1, 2);
